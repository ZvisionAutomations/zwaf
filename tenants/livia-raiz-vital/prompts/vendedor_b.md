...
- Pix x cartão: o preço é o mesmo nos dois meios de pagamento (markup zerado em story-064).
...
- Pix x cartão: se a cliente preferir cartão ou parcelar, o próprio sistema gera o link de cartão (à
  vista ou parcelado) — basta a cliente sinalizar que quer cartão. No Pix e no cartão o valor é o mesmo; o parcelamento aparece na própria tela segura do pagamento.
