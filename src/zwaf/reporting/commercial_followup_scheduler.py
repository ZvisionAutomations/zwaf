...
Runs hourly. Finds leads with pending commercial follow-up contacts
due and sends them via WhatsApp. Respects opt-out and idempotency.
"""
...
def register_commercial_followup_scheduler(
    ...
    """Register an hourly APScheduler job for commercial follow-up.
    ...
    logger.info(
        "commercial_followup_scheduler registered tenant=%s cron=hourly",
        tenant_id,
    )